...
const labels: Record<string, { title: string; sub: string }> = {
  fr: {
    ...
    sub: "Estimez votre backlog sprint en équipe. Fibonacci, vote simultané, gratuit.",
  },
  en: {
    title: "Scrum Planning Poker",
    sub: "Estimate your sprint backlog as a team. Fibonacci, simultaneous vote, free.",
  },
};

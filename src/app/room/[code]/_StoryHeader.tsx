    ...
    return (
      ...
      >
        <input
          ...
          maxLength={200}
          placeholder={d.storyPlaceholder}
          className="flex-1 rounded-lg border border-token-strong bg-surface px-3 py-2 text-lg text-fg outline-none focus:border-indigo-500 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-1"
        />
  ...
  return (
    <div className="flex items-start gap-3">
      <h2 className="flex-1 text-2xl font-semibold tracking-tight text-fg">
        {story || <span className="italic text-faint">{d.noStory}</span>}
      </h2>
      {isAdmin && (
        <button
          type="button"

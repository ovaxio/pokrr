    ...
    <div className="min-h-screen bg-bg text-fg">
      ...
      <main className="mx-auto flex min-h-screen max-w-3xl flex-col gap-5 px-4 py-5 sm:px-6 sm:gap-6 sm:py-6">
        <header className="flex items-center justify-between gap-3 text-sm">
          <Link href="/" className="font-bold tracking-tight text-lg text-fg hover:text-indigo-500">
            pokrr
          </Link>
        ...
        {room.errorMsg && !isKicked && (
          <div className="flex items-center justify-between gap-3 rounded-lg border border-red-300 dark:border-red-900/60 bg-red-50 dark:bg-red-950/40 px-3 py-2 text-sm text-red-900 dark:text-red-200">
